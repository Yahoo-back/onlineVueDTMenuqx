        ...
        <div class="demo-input-suffix">
          ...
          <div class="searchc">
            <el-select v-model="user_auth_cnd" placeholder="请选择认证状态" style="width:180px">
              ...
              <el-option label="个人" value="2">个人</el-option>
              <el-option label="银行卡" value="3">银行卡</el-option>
              <el-option label="联系人" value="4">联系人</el-option>
              <el-option label="运营商" value="5">运营商</el-option>
            </el-select>
          </div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              {{scope.row.user_auth == '活体' ? '身份证' : scope.row.user_auth == '个人信息' ? '个人信息' :
              scope.row.user_auth == '联系人' ? '联系人' : scope.row.user_auth == '银行卡' ? '银行卡' : scope.row.user_auth == '运营商' ? '运营商' : '未认证'}}
            </template>
          </el-table-column>
					<el-table-column
            prop="pay_amt"
