...
<template>
    ...
    <div style="float: right; margin-top: 25px; margin-bottom: 20px">
      <el-button type="primary" @click="handleSubmit" v-if="this.$route.query.view==2">保存</el-button>
      <el-button type="primary" @click="handleSubmitAdd" v-else-if="this.$route.query.view==3">保存</el-button>
